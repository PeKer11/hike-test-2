...
class SimulatedWalkTracker {
    ...
    cumulativeDist;
    totalDistance;
    constructor(geometry, onUpdate, onError, attractions = [], paceMinPerKm = 15, speedMultiplier = 10, tickMs = 500){
        this.geometry = geometry;
        this.attractions = attractions;
...
function HomePage() {
    ...
    const handleStartWalk = ()=>{
        ...
        const tracker = isSimulating ? new __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$test$2f$hiking$2d$route$2d$planner$2f$src$2f$lib$2f$walk$2f$simulated$2d$walk$2d$tracker$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SimulatedWalkTracker"](walkGeometryRef.current, onPositionUpdate, onGpsError, attractions, walkInputRef.current?.walkingPaceMinPerKm ?? 15) : new __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$test$2f$hiking$2d$route$2d$planner$2f$src$2f$lib$2f$walk$2f$walk$2d$tracker$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["WalkTracker"](onPositionUpdate, onGpsError, attractions, walkGeometryRef.current);
...
_s(HomePage, "gHTpwc8/G3onO4EFJlom3+LjPto=", false, function() {
    return [
...
//# sourceMappingURL=Documents_test_hiking-route-planner_src_51a171d0._.js.map