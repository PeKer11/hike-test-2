...
async function searchBestHike(request, baseConstraints) {
    const trails = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$rtg$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getRtgTrails"])();
        ...
        try {
            ...
            return {
                ...
                route: {
                    ...route,
                    source: "rtg",
                    sourceLabel: selected.trail?.source === "rtg-official" ? "RTG-Guided Route (path approximated)" : "RTG-Guided Route (curated trail, path approximated)",
                    warnings: [
                        ...route.warnings,
...
//# sourceMappingURL=src_7cfd9460._.js.map