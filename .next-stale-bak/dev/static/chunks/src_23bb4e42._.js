...
function HikeSearchPanel({ isSearching, onFindHike }) {
    _s();
    const [originLat, setOriginLat] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("31.7683");
    const [originLng, setOriginLng] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("35.2137");
...
_s(HikeSearchPanel, "zkqS4bRyVIPuYo3wYQNAFiwDUbc=");
_c = HikeSearchPanel;
var _c;
...
function scoreTrail(trail, request, originDistance, endpointDistance) {
    ...
    const proximityOrigin = originDistance <= PREFERRED_TRAILHEAD_DISTANCE_METERS ? 1 : Math.max(0, 1 - (originDistance - PREFERRED_TRAILHEAD_DISTANCE_METERS) / (ORIGIN_RADIUS_METERS - PREFERRED_TRAILHEAD_DISTANCE_METERS));
...
_s(HomePage, "yyknwT6/5Y/jsU6dKXrZxoiOvvE=", false, function() {
    return [
...
//# sourceMappingURL=src_23bb4e42._.js.map