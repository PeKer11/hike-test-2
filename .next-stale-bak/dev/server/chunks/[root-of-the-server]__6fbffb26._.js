...
function inferCategory(tags) {
    ...
    if (tourism === "attraction" || tourism === "artwork") return "landmark";
...
[out:json][timeout:25];
(
  node["tourism"~"museum|attraction|viewpoint|artwork|gallery|theme_park"](around:${r},${lat},${lng});
  ...
  way["tourism"~"museum|attraction|viewpoint"](around:${r},${lat},${lng});
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6fbffb26._.js.map