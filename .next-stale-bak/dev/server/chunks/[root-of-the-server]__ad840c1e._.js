...
"[project]/Documents/test/hiking-route-planner/src/lib/attractions/overpass-client.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function fetchAttractions(center, radiusMeters) {
    ...
    const attempts = OVERPASS_ENDPOINTS.flatMap((endpoint)=>[
            {
                endpoint,
                method: "POST"
            },
    ...
    for (const attempt of attempts){
        try {
            ...
            const response = attempt.method === "POST" ? await fetch(attempt.endpoint, {
                method: "POST",
                headers: {
                    ...REQUEST_HEADERS,
            ...
            if (!response.ok) {
                ...
                lastError = new Error(`Overpass API error: ${response.status} ${response.statusText}${detail ? ` - ${detail}` : ""}`);
    ...
    if (lastError.message.includes("403") || lastError.message.toLowerCase().includes("forbidden")) {
        throw new Error("Public map data service temporarily rejected the walk request. Please try again in a moment or adjust the area slightly.");
    }
    throw lastError;
}
}),
...
"[project]/Documents/test/hiking-route-planner/src/lib/attractions/attraction-ranker.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function rankAttractions(attractions, options) {
    ...
    for (const a of attractions){
        const distanceMeters = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$test$2f$hiking$2d$route$2d$planner$2f$src$2f$lib$2f$utils$2f$geo$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["haversineDistance"])(origin, a.coordinates);
...
"[project]/Documents/test/hiking-route-planner/src/lib/api/ors-client.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/Documents/test/hiking-route-planner/src/lib/optimization/tsp-planner.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function distBetween(a, b) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$test$2f$hiking$2d$route$2d$planner$2f$src$2f$lib$2f$utils$2f$geo$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["haversineDistance"])(a.coordinates, b.coordinates);
}
...
function planWalkOrderDebug(request, candidates) {
    const originPoint = {
    ...
    const optimizedTourIndices = twoOpt([
        ...nnTourIndices
    ], matrix, 0);
...
"[project]/Documents/test/hiking-route-planner/src/lib/utils/polyline.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/Documents/test/hiking-route-planner/src/app/api/walk-plan/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$test$2f$hiking$2d$route$2d$planner$2f$src$2f$lib$2f$attractions$2f$overpass$2d$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Documents/test/hiking-route-planner/src/lib/attractions/overpass-client.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$test$2f$hiking$2d$route$2d$planner$2f$src$2f$lib$2f$attractions$2f$attraction$2d$ranker$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Documents/test/hiking-route-planner/src/lib/attractions/attraction-ranker.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$test$2f$hiking$2d$route$2d$planner$2f$src$2f$lib$2f$api$2f$ors$2d$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Documents/test/hiking-route-planner/src/lib/api/ors-client.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$test$2f$hiking$2d$route$2d$planner$2f$src$2f$lib$2f$optimization$2f$tsp$2d$planner$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Documents/test/hiking-route-planner/src/lib/optimization/tsp-planner.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$test$2f$hiking$2d$route$2d$planner$2f$src$2f$lib$2f$utils$2f$geo$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Documents/test/hiking-route-planner/src/lib/utils/geo.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$test$2f$hiking$2d$route$2d$planner$2f$src$2f$lib$2f$utils$2f$polyline$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Documents/test/hiking-route-planner/src/lib/utils/polyline.ts [app-route] (ecmascript)");
;
;
;
;
...
async function POST(request) {
    try {
        ...
        const raw = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$test$2f$hiking$2d$route$2d$planner$2f$src$2f$lib$2f$attractions$2f$overpass$2d$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fetchAttractions"])(origin, radiusMeters);
        // 2. Rank and pre-filter by time budget
        const ranked = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$test$2f$hiking$2d$route$2d$planner$2f$src$2f$lib$2f$attractions$2f$attraction$2d$ranker$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["rankAttractions"])(raw, {
            origin,
            preferredCategories: body.preferredCategories,
            availableMinutes,
            walkingPaceMinPerKm
        });
        const { selected } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$test$2f$hiking$2d$route$2d$planner$2f$src$2f$lib$2f$attractions$2f$attraction$2d$ranker$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["selectFeasibleAttractions"])(ranked, availableMinutes, walkingPaceMinPerKm);
        ...
        const plan = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$test$2f$hiking$2d$route$2d$planner$2f$src$2f$lib$2f$optimization$2f$tsp$2d$planner$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["buildWalkPlan"])(planRequest, selected);
        ...
        if (plan.orderedAttractions.length > 0 && process.env.ORS_API_KEY) {
            try {
                ...
                const orsRes = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$test$2f$hiking$2d$route$2d$planner$2f$src$2f$lib$2f$api$2f$ors$2d$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getDirections"])({
                    coordinates: waypoints.map(__TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$test$2f$hiking$2d$route$2d$planner$2f$src$2f$lib$2f$utils$2f$geo$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["toOrsCoord"]),
                    profile: "foot-walking",
                    instructions: false
                });
                const encoded = orsRes.routes[0]?.geometry;
                if (encoded) {
                    geometry = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$test$2f$hiking$2d$route$2d$planner$2f$src$2f$lib$2f$utils$2f$polyline$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["decodePolyline"])(encoded);
                }
            } catch  {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ad840c1e._.js.map